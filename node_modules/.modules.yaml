...
hoistedDependencies:
  ...
  '@nestjs/config@4.0.4(@nestjs/common@10.4.22(class-transformer@0.5.1)(class-validator@0.15.1)(reflect-metadata@0.2.2)(rxjs@7.8.2))(rxjs@7.8.2)':
  ...
  packages/backend:
    '@uttt/backend': private
  packages/frontend:
    '@uttt/frontend': private
  packages/shared:
    '@uttt/shared': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Wed, 20 May 2026 20:58:42 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
storeDir: /Users/cjs/Library/pnpm/store/v3
